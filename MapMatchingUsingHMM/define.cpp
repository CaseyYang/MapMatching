...
long double dp[10000][CANADIDATEEDGES];								//动态规划概率
int dpSize[10000];									//每个点附近有多少边
int dpEdge[10000][CANADIDATEEDGES];								//动态规划记录边的Id
double dpLeft[10000][CANADIDATEEDGES];							//动态规划剩余
double dpLen[10000][CANADIDATEEDGES];							//动态规划每条边的几何计算长度
int dpPre[10000][CANADIDATEEDGES];								//动态规划记录路径
