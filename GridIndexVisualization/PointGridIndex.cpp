...
pair<double, double> PointGridIndex::getCenterCorrdinate(pair<int, int> cellIndex){
	return make_pair<double, double>(cellIndex.first*this->gridSizeDeg + area->minLat, cellIndex.second*this->gridSizeDeg + area->minLon);
}
